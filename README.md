...
•	En el desarrollo del trabajo se seleccionan, a través de una red neuronal (definición central en el aprendizaje profundo), 5 acciones que cumplan con ciertos requisitos.
